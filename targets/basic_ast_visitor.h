// $Id: basic_ast_visitor.h,v 1.18 2015/04/14 05:46:59 ist158803 Exp $ -*- c++ -*-
...
public:
  ...
  virtual void do_addressing_node(pwn::addressing_node * const node, int lvl) = 0;
  virtual void do_indpos_node(pwn::indpos_node * const node, int lvl) = 0;

public:
  virtual void do_var_node(pwn::var_node * const node, int lvl) = 0;
  virtual void do_declvar_node(pwn::declvar_node * const node, int lvl) = 0;
  virtual void do_declfunc_node(pwn::declfunc_node * const node, int lvl) = 0;
  virtual void do_defunc_node(pwn::defunc_node * const node, int lvl) = 0;
  virtual void do_callfunc_node(pwn::callfunc_node * const node, int lvl) = 0;
